...
corpus = Corpusv2(args.data)
print("corpus {}".format(len(corpus.dictionary)))
print(corpus.dictionary)



# for i in corpus.dictionary.word2idx:
#     print(i)
print(len(corpus.dictionary.classes))
for idx,c in enumerate(corpus.dictionary.classes):
    print(c,idx)
...
try:
    for epoch in range(1, args.epochs+1):
        ...
        if not best_val_loss or val_loss < best_val_loss:
            cpkt_fol_name = './checkpoints/' + 'RNNLM_test_day' + timestamp
            ...
            with open(cpkt_fol_name + '/model_arguments.txt', 'w') as f:
                json.dump(args.__dict__, f, indent=2)

            with open(cpkt_fol_name+'/model.pth', 'wb') as f:
                torch.save(model, f)
